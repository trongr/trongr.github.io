...
Another name for learning the policy (the best action to take in any given
state), as opposed to learning the value of each state (and the best state) for
the agent to be in. Can combine both approaches: learn both the best states and
the best actions to take in each state?
